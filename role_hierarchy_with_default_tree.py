...
if __name__ == "__main__":
    ...
    root.add_child(COO)
    root.add_child(CTO)
    Senior_prod_engg_mgn = Node('Sr Product Engineering Manager')
    Senior_prod_mkt_mgn = Node('Sr Product Marketing Manager')
    COO.add_child(Senior_prod_engg_mgn)
    COO.add_child(Senior_prod_mkt_mgn)
    DOT = Node('Director of Technology')
    CTO.add_child(DOT)
    ME = Node('Manager Engineering')
    Senior_prod_engg_mgn.add_child(ME)
    MM = Node('Marketing Manager')
    Senior_prod_mkt_mgn.add_child(MM)
    TA = Node('Technical Architect')
    DOT.add_child(TA)
    Devops = Node('DevOps')
    Dev = Node('Developer')
    Tester = Node('Tester')
    ...
    ME.add_child(Dev)
    ME.add_child(Tester)
    MA = Node('Marketing Analyst')
    MEx = Node('Marketing Executive')
    MM.add_child(MA)
    MM.add_child(MEx)

    root.name.append('Tyson')
    COO.name.append('Ray')
    DOT.name.append('Max')
    DOT.name.append('Kenny')
    Senior_prod_engg_mgn.name.append('Will')

    users = {'Tyson':'CEO',
    'Ray':'COO',
    'Max':'Director of Technology',
    'Kenny':'Director of Technology',
    'Will':'Sr Product Engineering Manager'
    }
